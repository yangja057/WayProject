...
public class WMyReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //여리고심.
        database.getReference().child("users").child(auth.getCurrentUser().getUid()).child("MyReviewList").child("-L-Wf-7IhvvnyblYPp-D").child("list").addValueEventListener(new ValueEventListener() {
            @Override
